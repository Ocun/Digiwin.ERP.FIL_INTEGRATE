...
//<description>上传转换接口</description>
//---------------------------------------------------------------- 
...
namespace Digiwin.ERP.FIL_INTEGRATE.Business {
    ...
    [TypeKeyOnly]
    [Description("上传转换接口")]
    public interface IInsertInterfaceConversionService {
        ...
        /// <returns></returns>
        Hashtable InsertInterfaceConversion(string employee_no, string scan_type, string report_datetime,
            string picking_department_no, string recommended_operations, string recommended_function,
            string scan_doc_no, DependencyObjectCollection scan);
    }
}
