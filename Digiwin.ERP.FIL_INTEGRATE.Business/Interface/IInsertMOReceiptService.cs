...
//<Description>产生生产入库单服务接口</Description>
//---------------------------------------------------------------- 
...
namespace Digiwin.ERP.FIL_INTEGRATE.Business {
    ...
    /// </summary>
    [TypeKeyOnly]
    [Description("产生生产入库单服务接口")]
    public interface IInsertMOReceiptService {
        /// <summary>
        /// 
        /// </summary>
        ...
        DependencyObjectCollection InsertMOReceipt(string employee_no, string scan_type, DateTime report_datetime, string picking_department_no,
