...
namespace Digiwin.ERP.FIL_INTEGRATE.Business {
    ...
    /// </summary>
    [TypeKeyOnly]
    [Description("获取到货单通知服务 接口")]
    public interface IGetPurchaseArrivalListService {
        ...
        /// <returns></returns>
        DependencyObjectCollection GetPurchaseArrival(string programJobNo, string scanType, string status, string siteNo
