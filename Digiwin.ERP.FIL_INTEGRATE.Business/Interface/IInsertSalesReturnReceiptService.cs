...
//<description>生成销退入库单服务 接口</description>
//---------------------------------------------------------------- 
...
namespace Digiwin.ERP.FIL_INTEGRATE.Business{
    ...
    /// </summary>
    [TypeKeyOnly]
    [Description("生成销退入库单服务 接口")]
    public interface IInsertSalesReturnReceiptService{
        /// <summary>
        /// 生成销退入库单服务
        /// </summary>
        ...
        DependencyObjectCollection DoInsertSalesReturnReceipt(string employeeNo, string scanType, DateTime reportDatetime,
