...
//<description>获取领料申请单通知服务</description>
...
namespace Digiwin.ERP.FIL_INTEGRATE.Business {
    [TypeKeyOnly]
    public interface IGetIssueReceiptReqListService {
        /// <summary>
        /// 获取领料申请单通知
        /// </summary>
        ...
        /// <returns></returns>
        DependencyObjectCollection GetIssueReceiptReqList(string programJobNo, string scanType, string status, string siteNo
