...
//<description>生成采购退货出库单服务 接口</description>
//---------------------------------------------------------------- 
...
namespace Digiwin.ERP.FIL_INTEGRATE.Business{
    ...
    /// </summary>
    [TypeKeyOnly]
    [Description("生成采购退货出库单 接口")]
    public interface IInsertPurchaseIssueService{
        /// <summary>
        /// 生成采购退货出库单
        /// </summary>
        ...
        DependencyObjectCollection DoInsertPurchaseIssue(string employeeNo, string scanType, DateTime reportDatetime,
