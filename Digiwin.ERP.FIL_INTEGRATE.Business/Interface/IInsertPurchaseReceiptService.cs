...
//<description>生成采购入库单 接口</description>
//---------------------------------------------------------------- 
...
namespace Digiwin.ERP.FIL_INTEGRATE.Business {
    ...
    /// </summary>
    [TypeKeyOnly]
    [Description("生成采购入库单 接口")]
    public interface IInsertPurchaseReceiptService {
        /// <summary>
        /// 插入领料出库单
        /// </summary>
        ...
        DependencyObjectCollection DoInsertPurchaseReceipt(string employeeNo, string scanType, DateTime reportDatetime, 
