...
namespace Digiwin.ERP.FIL_INTEGRATE.Business {
    [TypeKeyOnly]
    public interface IGetMOReceiptReqService {
        /// <summary>
        /// 获取入库申请单
        /// </summary>
        ...
        /// <returns></returns>
        DependencyObjectCollection GetMOReceiptReq(string programJobNo, string scanType, string status, string[] docNo, string id, string siteNo);
    }
}
