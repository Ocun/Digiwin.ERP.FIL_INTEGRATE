...
//<description>更新领退料单服务接口</description>
//----------------------------------------------------------------  
...
namespace Digiwin.ERP.FIL_INTEGRATE.Business {
    [TypeKeyOnly]
    [Description("更新领退料单服务接口")]
    public interface IUpdateIssueReceiptService {
        /// <summary>
        /// 更新领退料单
        /// </summary>
        ...
        DependencyObjectCollection UpdateIssueReceipt(string employeeNo, string scanType, DateTime reportDatetime, string pickingDepartmentNo
