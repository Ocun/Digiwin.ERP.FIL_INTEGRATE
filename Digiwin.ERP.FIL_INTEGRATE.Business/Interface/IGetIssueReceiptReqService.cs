...
namespace Digiwin.ERP.FIL_INTEGRATE.Business {
    [TypeKeyOnly]
    public interface IGetIssueReceiptReqService {
        /// <summary>
        /// 获取领料申请单
        /// </summary>
        ...
        /// <returns></returns>
        DependencyObjectCollection GetIssueReceiptReq(string programJobNo, string scanType, string status, string[] docNo, string id, string siteNo);
    }
}
