...
namespace Digiwin.ERP.FIL_INTEGRATE.Business {
    [TypeKeyOnly]
    public interface IGetMOReceiptReqListService {
        /// <summary>
        /// 获取入库申请单通知
        /// </summary>
        ...
        /// <returns></returns>
        DependencyObjectCollection GetMOReceiptReqList(string programJobNo, string scanType, string status, string siteNo
