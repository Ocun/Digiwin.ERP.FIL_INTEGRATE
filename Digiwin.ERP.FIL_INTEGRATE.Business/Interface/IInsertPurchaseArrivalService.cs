...
//<CreateDate>2016/11/16 16:32:41</CreateDate>
//<IssueNO>P001-161101003</IssueNO>
//<Description>产生到货单服务接口</Description>
//----------------------------------------------------------------  
...
namespace Digiwin.ERP.FIL_INTEGRATE.Business {
    ...
    /// </summary>
    [TypeKeyOnly]
    [Description("产生到货单服务接口")]
    public interface IInsertPurchaseArrivalService {
        /// <summary>
        /// 
        /// </summary>
        ...
        DependencyObjectCollection InsertPurchaseArrival(string employee_no, string scan_type, DateTime report_datetime, string picking_department_no,
