...
//<description>获取领退料通知服务 接口</description>
//---------------------------------------------------------------- 
...
namespace Digiwin.ERP.FIL_INTEGRATE.Business {
    ...
    /// </summary>
    [TypeKeyOnly]
    [Description("获取领退料通知服务 接口")]
    public interface IGetIssueReceiptListService {
        ...
        /// <returns></returns>
        DependencyObjectCollection GetIssueReceipt(string programJobNo, string scanType, string status, string siteNo
