...
//<description>获取寄售订单服务</description>
...
namespace Digiwin.ERP.FIL_INTEGRATE.Business.Implement {
    [ServiceClass(typeof(IGetSalesOrderService))]
    [Description("获取寄售订单服务")]
    public class GetSalesOrderService : ServiceComponent, IGetSalesOrderService {
        ...
        /// <returns></returns>
        public DependencyObjectCollection GetSalesOrder(string programJobNo, string status, string scanType, string[] docNo, string id, string siteNo) {
            #region 参数检查
            ...
            if (Maths.IsEmpty(docNo) && Maths.IsEmpty(id)) {
                var infoCodeSer = GetService<IInfoEncodeContainer>(); //信息编码服务
                throw new BusinessRuleException(infoCodeSer.GetMessage("A111201", "doc_no、ID"));//‘入参【doc_no、ID】未传值’//message A111201
            }
            ...
            #endregion
            //查询寄售订单
            return GetSalesOrderDoc(programJobNo, status, docNo, siteNo);
        }
